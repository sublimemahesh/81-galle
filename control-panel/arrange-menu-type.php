                ...
                <div class="row clearfix">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                <form method="post" action="post-and-get/menu-type.php" class="form-horizontal" >
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 arrange-container">
                                                <ul id="sortable">
                                                    ...
                                                    <?php
                                                    if (count($MENU_TYPE->all()) > 0) {
                                                        foreach ($MENU_TYPE->all() as $key => $img) {
                                                            ?>
                                                    
                                                            <div class="col-md-3" style="list-style: none;">
                                                                <li class="ui-state-default">
                                                                    <span class="number-class">(<?php echo $key + 1; ?>)</span>
                                                                    <img class="img-responsive" src="../upload/menu-type//<?php echo $img["image_name"]; ?>" alt=""/>
