...
<div class="csi-container ">
   ...
   <?php include './header.php'; ?>
    ...
    <!--TEAM-->
<!--    <section>
        <div id="csi-team" class="csi-team">
            <div class="csi-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="csi-heading">
                                <h3 class="subtitle">Team of Foodking</h3>
                                <h2 class="title">Experienced Chefs</h2>
                            </div>
                        </div>
                    </div>
                    <div class="team-featured-area">
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team1.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Jhone Eonathon</a></h3>
                                            <h4 class="subtitle">Head Chef</h4>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team2.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Abu Sayem Leader</a></h3>
                                            <h4 class="subtitle">Chef of Foodking</h4>
                                            <ul class="list-inline social-area">
                                                <li><a href="#"><i class="fa fa-facebook-f" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team3.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Jhone Zahidul</a></h3>
                                            <h4 class="subtitle">Chef of Foodking</h4>
                                            <ul class="list-inline social-area">
                                                <li><a href="#"><i class="fa fa-facebook-f" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team2.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Devid Vaskar</a></h3>
                                            <h4 class="subtitle">Chef of Foodking</h4>
                                            <ul class="list-inline social-area">
                                                <li><a href="#"><i class="fa fa-facebook-f" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team3.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Riaz Sagar</a></h3>
                                            <h4 class="subtitle">Chef of Foodking</h4>
                                            <ul class="list-inline social-area">
                                                <li><a href="#"><i class="fa fa-facebook-f" aria-hidden="true"></i></a></li>
                                                <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="team-single">
                                    <figure>
                                        <a class="team-img" href="#"><img src="assets/img/team/team6.jpg" alt="team"/></a>
                                        <figcaption>
                                            <h3 class="title"><a href="#">Jhone Eonathon</a></h3>
                                            <h4 class="subtitle">Chef of Foodking</h4>
                                            <ul class="list-inline social-area">
...
<!--                                        <figcaption>
                                    ...
                                    <div class="author-info">
                                        <h1 class="title"><a href="#">Mission</a></h1>
...
<!-- Mirrored from httpcoder.com/demo/html/foodking/view/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 12 Jun 2018 04:59:39 GMT -->
</html>
